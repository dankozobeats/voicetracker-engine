  ...
  return currentMonth.categoryBudgets.map((currentBudget) => {
    ...
    if (!previousBudget) {
      return {
        ...
        previous: 0,
        currentFixedCharges: currentBudget.fixedCharges,
        previousFixedCharges: 0,
        currentVariableSpent: currentBudget.variableSpent,
        previousVariableSpent: 0,
    ...
    return {
      ...
      currentFixedCharges: currentBudget.fixedCharges,
      previousFixedCharges: previousBudget.fixedCharges,
      currentVariableSpent: currentBudget.variableSpent,
      previousVariableSpent: previousBudget.variableSpent,
      delta,
      percentChange,
      trend,
    };
