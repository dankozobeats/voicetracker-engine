...
export function buildSystemPrompt(): string {
  return [
    ...
    '- Proposed actions must be suggestions only, never executed, and must set requiresConfirmation=true.',
    ...
    '  "proposedActions": [{"title":"...","description":"...","requiresConfirmation":true,"payload":{}}],',
